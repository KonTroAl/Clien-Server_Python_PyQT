...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.DialectDBComboBox = QtWidgets.QComboBox(self.centralwidget)
        self.DialectDBComboBox.setGeometry(QtCore.QRect(430, 390, 90, 30))
        self.DialectDBComboBox.setObjectName("DialectDBComboBox")
        self.DialectDBComboBox.addItem("")
        self.DialectDBComboBox.addItem("")
        ...
        MainWindow.setTabOrder(self.PortTextBox, self.DialectDBComboBox)
        MainWindow.setTabOrder(self.DialectDBComboBox, self.NameDBTextBox)
        MainWindow.setTabOrder(self.NameDBTextBox, self.PortConnectionButton)
        MainWindow.setTabOrder(self.PortConnectionButton, self.ClientsList)
        MainWindow.setTabOrder(self.ClientsList, self.ClientsStatistic)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DialectDBComboBox.setItemText(0, _translate("MainWindow", "sqlite"))
        self.DialectDBComboBox.setItemText(1, _translate("MainWindow", "mySQL"))
